...
**Weiss Pro offers support for Tiers from version 3.0.0**, that means that if you use this version or a newer one you will be able to offer your users the different tiers that you configure in the Ghost Admin.
...
![Membership tiers](https://res.cloudinary.com/edev/image/upload/v1655569388/weiss-pro/CleanShot_2022-06-18_at_18.22.09.png)

## Portal

If you want to use [Portal](https://ghost.org/help/setting-up-portal/) for all Members functionalities instead of the ones provided by the theme you can enable the "**Use portal for members**" option found in the theme settings as shown in the following screenshot:

![Portal setting](https://res.cloudinary.com/edev/image/upload/v1682171571/weiss-pro/CleanShot_2023-04-22_at_15.52.15.png)
...
::: warning
This option is only available if you're using Ghost 4.20.0 or later and Weiss Pro 3.2.0 or later.
:::
